package com.wells.rad.case.manager.repository;

import com.wells.rad.case.manager.RadCaseManagerApp;
import com.wells.rad.case.manager.config.Constants;
import com.wells.rad.case.manager.config.audit.AuditEventConverter;
import com.wells.rad.case.manager.domain.PersistentAuditEvent;
...
import static com.wells.rad.case.manager.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
